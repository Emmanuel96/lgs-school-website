          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Header <small>Changes to the Header section of the Website</small></h3>
              </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Header Form<small>Design The Header To Speak Your Mind</small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                    ...
                    <form id="demo-form2" action = "{{url('admin/edit/header')}}" enctype="multipart/form-data" METHOD = "POST" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
						  ...
						  <button class="btn btn-primary" onClick= "document.getElementById('myForm').reset();" type="reset">Reset</button>

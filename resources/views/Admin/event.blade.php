          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Events <small>Make front end display of events under your control</small></h3>
              </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Events:<small>Edit Events For Display</small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name" maxlength = "25">Event Description<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
